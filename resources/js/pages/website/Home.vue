          ...
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              <div class="flex-shrink-0 flex items-center">
                <i class="fas fa-building text-2xl text-brand-green mr-3"></i>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div class="text-white order-2 lg:order-1">
            ...
            <p class="text-lg sm:text-xl mb-8 text-gray-100 leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <a href="#services"
                class="bg-white text-brand-green px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:bg-gray-100 transition duration-300 text-center">
                <i class="fas fa-rocket mr-2"></i>Our Services
              </a>
              <a href="#contact"
                class="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:bg-white hover:text-brand-green transition duration-300 text-center">
            ...
            <div class="relative">
              ...
              <div class="mt-6 flex justify-center space-x-4">
                <button @click="prevSlide"
                  class="bg-brand-green hover:bg-brand-green/90 text-white w-10 h-10 sm:w-12 sm:h-12 rounded-full transition duration-300 flex items-center justify-center shadow-lg">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p class="text-lg text-gray-600 mb-6">
              From creating robust structures to maintaining them with precision, and optimizing your HVAC and IT
              systems, our team is committed to delivering exceptional results on time and to the highest standards.
            </p>
            <p class="text-lg text-gray-600">
              Our expertise spans across various sectors, ensuring that we meet the evolving needs of our clients with
              precision and excellence. Al Najm Al Saeed Co. Ltd. is your trusted partner for high-quality, reliable,
              and efficient services that drive success and sustainability in every project we undertake.
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="service-card bg-white p-8 rounded-xl shadow-lg border border-gray-100 transition duration-300">
            <div class="w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center mb-6">
              <i class="fas fa-hard-hat text-3xl text-green-600"></i>
            </div>
          ...
          <div class="service-card bg-white p-8 rounded-xl shadow-lg border border-gray-100 transition duration-300">
            <div class="w-16 h-16 bg-purple-100 rounded-lg flex items-center justify-center mb-6">
              <i class="fas fa-paint-brush text-3xl text-purple-600"></i>
            </div>
          ...
          <div class="service-card bg-white p-8 rounded-xl shadow-lg border border-gray-100 transition duration-300">
            <div class="w-16 h-16 bg-yellow-100 rounded-lg flex items-center justify-center mb-6">
              <i class="fas fa-umbrella text-3xl text-yellow-600"></i>
            </div>
          ...
          <div class="service-card bg-white p-8 rounded-xl shadow-lg border border-gray-100 transition duration-300">
            <div class="w-16 h-16 bg-indigo-100 rounded-lg flex items-center justify-center mb-6">
              <i class="fas fa-laptop-code text-3xl text-indigo-600"></i>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="bg-gray-100 rounded-2xl p-8">
            ...
            <form @submit.prevent="submitCallbackForm" class="space-y-4">
              ...
              <button type="submit"
                class="w-full bg-brand-green hover:bg-brand-green/90 text-white py-3 px-6 rounded-lg font-semibold transition duration-300">
                <i class="fas fa-paper-plane mr-2"></i>Request Call Back
              </button>
            </form>
          </div>
        </div>
    ...
    <section id="career" class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-lg">
          <div class="text-center">
            <i class="fas fa-users text-6xl text-brand-green mb-6"></i>
            ...
            <a href="#contact"
              ...
              <i class="fas fa-envelope mr-2"></i>Send Your Resume
            </a>
          </div>
        </div>
      </div>
