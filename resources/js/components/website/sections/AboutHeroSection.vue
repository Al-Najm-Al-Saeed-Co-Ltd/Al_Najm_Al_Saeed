    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16 sm:py-20">
      <div class="text-center text-white">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="ml-1 text-gray-200 md:ml-2">About Us</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
          About
          <span class="text-white">Al Najm Al Saeed</span>
        </h1>
        <p class="text-base sm:text-lg md:text-xl mb-8 text-gray-100 leading-relaxed max-w-4xl mx-auto">
          Building Excellence Through Innovation & Quality
        </p>
        <p class="text-sm sm:text-base md:text-lg mb-8 text-gray-200 leading-relaxed max-w-5xl mx-auto">
          For over 15 years, Al Najm Al Saeed Co. Ltd. has been your trusted partner in construction, HVAC, and
          technology solutions.
          We deliver excellence through innovation, quality craftsmanship, and unwavering commitment to our clients'
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            ...
            <p class="text-xs text-gray-200">15+ Years</p>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            <CheckCircle class="w-6 h-6 mx-auto mb-2 text-white" />
            <p class="text-xs text-gray-200">150+ Projects</p>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            <Heart class="w-6 h-6 mx-auto mb-2 text-white" />
            <p class="text-xs text-gray-200">98% Satisfaction</p>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            <Shield class="w-6 h-6 mx-auto mb-2 text-white" />
            <p class="text-xs text-gray-200">Quality Assured</p>
          </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
          ...
          <Phone class="w-5 h-5 mr-2" />Get In Touch
          </Link>
          <a href="#story"
            ...
            <BookOpen class="w-5 h-5 mr-2" />Our Story
          </a>
        </div>
      </div>
    </div>
