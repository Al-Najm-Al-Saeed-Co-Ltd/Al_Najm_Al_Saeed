    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-16 sm:py-20">
      <div class="text-center text-white">
        ...
        <p class="text-sm sm:text-base md:text-lg mb-8 text-gray-200 leading-relaxed max-w-5xl mx-auto">
          From construction and HVAC systems to cutting-edge IT solutions, we deliver excellence in every project. 
          Our expert team provides comprehensive services with unmatched quality, innovation, and customer satisfaction.
        </p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
          ...
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            <Users class="w-6 h-6 mx-auto mb-2 text-white" />
            <p class="text-xs text-gray-200">Expert Team</p>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            <Award class="w-6 h-6 mx-auto mb-2 text-white" />
            <p class="text-xs text-gray-200">Certified Services</p>
          </div>
        </div>
...
import { Phone, Rocket, Shield, Clock, Users, Award } from 'lucide-vue-next'
</script>
